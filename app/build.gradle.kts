...
dependencies {
    ...
    // Compose BOM + Compose libs (BOM pins compose versions for ui/material/etc)
    ...
    // MPAndroidChart (correct coordinate - no leading 'v')
    implementation("com.github.PhilJay:MPAndroidChart:3.1.0")

    // Coil for image loading (Compose)
    implementation("io.coil-kt:coil-compose:2.5.0")

    // PDF (if you actually need the full iText bundle consider smaller alternatives)
    ...
    // Optional: Material Components (useful for non-Compose components or dialogs)
